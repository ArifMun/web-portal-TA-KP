...
<div class="sidebar">
    ...
    <div class="sidebar-wrapper scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav">
                @if (empty($pengumuman->cttn_daftar_ta))
                ...
                <li class="nav-item mr-2">
                    ...
                    <a href="">
                        <span style="margin: -20px 0 0 0px">{!! $pengumuman->cttn_daftar_ta !!}</span>
                    </a>
                </li>
                @endif
            </ul>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title text-center">DAFTAR DOSEN PEMBIMBING TUGAS AKHIR</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="daftar-pembimbing" class="display table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-capitalize">
                                            ...
                                            <td class="text-center">{{ $item->stts_ta }}</td>
